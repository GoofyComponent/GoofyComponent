<script>
    ...
    export let confirmMsg = "Confirmer";
...
<section id="AlertModalContainer">
    <section class="AlertModalContent">
        <div class="alertModalText">
            <h1 class="modalTitle">
            {modalTitle}
            </h1>
        ...
        <div class="AlertModalButtons">
            <button class="AlertModalButton" on:click={rejectAction && rejectAction}>
                {rejectMsg}
            </button>
            <button class="AlertModalButton" on:click={confirmAction && confirmAction}>
                {confirmMsg}
            </button>
        </div>
        {/if}
